...
func Welcome(w http.ResponseWriter, r *http.Request) {
	...
	tknStr := c.Value
	//tknStr := "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6InVzZXIxIiwiZXhwIjoxNjEwNTI4OTg0fQ.YiL76fZzEof61hYX5zqeWYMQDhCHD95mlzwzzEnCWQw"
